...
public class Main {
    ...
    private static void inputNumber() {
        ...
        System.out.println("Digite a linha em que o número será inserido: ");
        int row = runUtilGetValidNumber(0,8);
        System.out.printf("Digite o número que será inserido na posição [%s,%s]: \n",col,row);
    ...
    private static void clearGame() {
        ...
        System.out.println("Tem certeza que deseja apagar o jogo e perder todo o seu progresso?");
